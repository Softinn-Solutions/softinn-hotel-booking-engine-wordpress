    ...
    <form method="post" action="">
        <table class="form-table">
            <tbody>
                ...
                <tr>
                    <th scope="row">Softinn Widget</th>
                    <td>
                        <p>
                            <span class="dashicons dashicons-calendar-alt" style="color: #46b450;"></span> The widget will allow user to input the date range of room reservation. The user will then be redirected to the Softinn Booking Engine page on a new tab. 
                        </p>
                    </td>
                </tr>
                <tr>
